...
def is_module(module_name: str) -> bool:
    ...
    # * Else if such module is loadable by iteratively querying all module
    #   loaders in "sys.meta_path" (the canonical list of such loaders), a new
    #   spec is created describing such module and returned.
    ...
    # Unfortunately, such exception does *NOT* necessarily imply such module to
    # not exist. Such module may exist even if such exception is thrown,
    ...
    #
    # Unfortunately, such exception does imply that conventional alternatives to
    # the prior function call (e.g., testing tuples generated by
    # pkgutil.iter_modules()) will also fail to find such module. As a fallback,
    # such module *MUST* be manually imported. Since doing so implicitly imports
    # the "__init__.py" files of all parent packages of such module and hence
