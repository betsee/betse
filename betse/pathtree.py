...
HOME_DIRNAME = ''   # initialized below
'''
...
# ....................{ CONSTANTS ~ file                   }....................
LOG_DEFAULT_FILENAME = ''   # initialized below
'''
Absolute path of the user-specific plaintext file to which `betse` logs
messages by default.
'''

SIMULATION_CONFIG_DEFAULT_FILENAME = ''   # initialized below
'''
...
def _init_pathnames() -> None:
    ...
    # relative to the absolute path of the current module.
        ...
        DATA_DIRNAME = paths.join(
            dirs.get_dirname(__file__), data_root_basename)
...
# PROGRAM_CONFIG_DEFAULT_FILENAME = ''   # initialized below
# '''
