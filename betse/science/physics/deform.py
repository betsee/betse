...
def getDeformation(sim, cells, t, p):
    ...
    Fx = (1 / p.lame_mu) * (p.media_rho * sim.J_cell_x * sim.rho_cells * p.galvanotropism + sim.gPxc)
    Fy = (1 / p.lame_mu) * (p.media_rho * sim.J_cell_y * sim.rho_cells* p.galvanotropism + sim.gPyc)
