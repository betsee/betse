...
#FIXME: We'll need to express the "scratch" type, as well. *sigh*
...
Note that *all* ion profiles unconditionally contain an unidentified
charge-balance anion denoted M-.
...
BASIC_CA : enum
    ...
    the superset of the :attr:`BASIC` profile additionally enabling Ca2+ ions.
MAMMAL : enum
    ...
    :attr:`BASIC_CA` profile additionally enabling Cl- and H+ ions.
AMPHIBIAN : enum
    Ion profile enabling M-, Na+, K+, proteins-, Ca2+, Cl-, and H+ ions
