...
#
#
#     def __init__(self,cells,trueVol=None,method=None):
#
#         if method == 'Euler':
#             self.mthd = 0
#         elif method == 'RK4':
...
#
#     def runInit(self,cells,timesteps):
#
#
#         tt = np.linspace(0,timesteps*p.dt,timesteps)
#         # report
#         print('Your sim initialization is running from',0,'to',timesteps*p.dt,'seconds, in-world time.')
...
#         with open(cellConc_init, 'wb') as f:
#             pickle.dump(cc_cells, f)
#         with open(envConc_init, 'wb') as f:
#             pickle.dump(cc_env, f)
#         with open(cellgeom_init, 'wb') as f:
#             pickle.dump(cells, f)
#
#
#
...
#
#         # report
#         print('Your simulation is running from',0,'to',timesteps*p.dt,'seconds, in-world time.')
#         # FIXME would be nice to have a time estimate for the simulation
#
#         for t in tt:   # run through the loop
#
